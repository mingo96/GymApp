...
@Entity(
    ...
    foreignKeys = [ForeignKey(entity = WorkOutEntity::class,parentColumns = ["workOutId"],childColumns = ["workoutId"], onDelete = ForeignKey.CASCADE),
    ForeignKey(entity = RoutineEntity::class,parentColumns = ["routineId"],childColumns = ["routineId"], onDelete = ForeignKey.CASCADE)
    ])
